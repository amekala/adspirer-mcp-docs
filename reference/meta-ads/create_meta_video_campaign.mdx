---
title: "create_meta_video_campaign"
sidebarTitle: "create_meta_video_campaign"
...
<ParamField path="call_to_action" type="string" default="&quot;WATCH_MORE&quot;">
  Call-to-action button. Options: 'WATCH_MORE' (default for video), 'LEARN_MORE', 'SHOP_NOW', 'SIGN_UP', 'DOWNLOAD', 'BOOK_TRAVEL', 'CONTACT_US'. Default: WATCH_MORE
</ParamField>
...
<ParamField path="optimize_for_reels" type="boolean" default="false">
  Whether to optimize for Reels placement. Set to true for vertical videos (9:16 aspect ratio).
</ParamField>
...
```
Create Meta Video Campaign for my account.
```

Your AI client will call the `create_meta_video_campaign` tool behind the scenes.
